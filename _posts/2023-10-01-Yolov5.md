...
![img](img/Yolov5/img_resize.png)

![img](img/Yolov5/img_resize2.png)
...
![img](img/Yolov5/batch.png)

- 배치 크기는 원하는대로, 너무 클 경우 메모리 과부하

### epoch 지정

![img](img/Yolov5/epoch.png)

- epoch 수치 입력

### yaml 파일 경로 지정

![img](img/Yolov5/yaml_train.png)

- 데이터셋 정보를 작성한 yaml파일 경로 작성

### pretrained weights 파일 읽기

![img](img/Yolov5/pretrained_weights.png)
...
![img](img/Yolov5/weight_save.png)

- 학습 후 최종 weights 파일과 모델 성능 평가 데이터를 저장할 위치 지정
- 
![img](img/Yolov5/weight_save_dir.png)
